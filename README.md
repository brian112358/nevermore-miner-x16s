...
An optimized fork of ccminer developed specially for x16r, and ported to x16s.
...
tpruvot (original x16s ccminer implementation):

- BTC: 1AJdfCpLWPNoAMDfHF1wD5y8VgKSSTHxPo

alexis78 (some optimized CUDA kernels for x16s)
